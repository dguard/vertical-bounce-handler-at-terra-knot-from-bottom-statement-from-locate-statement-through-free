...
function RectangleOnPaper(radius, frontRatio, p, d, debthScaleRatio, profileScaleRatio, frontScaleRatio) {
    ...
    that.drawFromBottom = function () {
        ...
        const handleProjectAt1stIteration = window['@pencil/handle-knot-pointer-belongings-from-front-statement']['handleProjectAt1stIteration']
        const handleProjectAt2ndIteration = window['@pencil/handle-knot-pointer-belongings-from-front-statement']['handleProjectAt2ndIteration']
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            let ctx = window['@pencil/draft-knot-pointer-belongings-from-front-statement']['passThroughFromBottom']['canvas']
...
window['@pencil/draft-compact-knot-pointer-belongings-from-front-statement'] = {
    DraftFabrikk,
    Pencil
}
