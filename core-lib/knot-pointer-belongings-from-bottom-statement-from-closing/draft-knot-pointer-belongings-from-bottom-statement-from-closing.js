...
(function() {
    ...
    const Pencil = window['@pencil/draft-compact-knot-pointer-belongings-from-bottom-statement-from-closing']['Pencil']
    const DraftFabrikk = window['@pencil/draft-compact-knot-pointer-belongings-from-bottom-statement-from-closing']['DraftFabrikk']

    // keep !
    let passThroughFromBottom = {}
    passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing'] = {}
    // keep

    passThrough['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing'] = function (spawnedPointerBelongings, passThroughKnot) {
...
passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing']['FIELD_OF_VIEW'] = FIELD_OF_VIEW
passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing']['PROJECTION_CENTER_Y'] = PROJECTION_CENTER_Y
passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing']['PROJECTION_CENTER_X'] = PROJECTION_CENTER_X

passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing']['canvas'] = ctx
...
let increaserDe = (fromDeTry + 4 + 3 + 2 + 4 + 3 + 2) / iterationCountAtDe
// increaserDe = (originalSpawnedPointerBelongings.knotAtTopLeftY - originalSpawnedPointerBelongings.knotAtBottomLeftY + referenceKnotAtProfile) / originalSpawnedPointerBelongings.knotRelativeSizeAtFront * ((1 * 4 * 2, 1, 1 * 4 * 1.7) / (1 * 2))
...
// keep
window['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing'] = {
    passThrough: passThrough['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing'],
    passThroughFromBottom: passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing']
}
// keep
