...
function handleProjectAt1stIteration(v1Project, v2Project, /* keep */ profileRatio, frontRatio, debthRatio, i) {
    // keep
    const PROJECTION_CENTER_Y = window['@pencil/drafr-knot-locate-draftar-from-front']['passThroughFromBottom']['PROJECTION_CENTER_Y']

    const PROJECTION_CENTER_X = window['@pencil/drafr-knot-locate-draftar-from-front']['passThroughFromBottom']['PROJECTION_CENTER_X']
...
window['@pencil/draft-handle-knot-locate-draftar-from-front'] = {
