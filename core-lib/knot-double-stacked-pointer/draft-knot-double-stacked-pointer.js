...
(function() {
    ...
    const Pencil = window['@pencil/draft-compact-knot-double-stacked-pointer']['Pencil']
    const DraftFabrikk = window['@pencil/draft-compact-knot-double-stacked-pointer']['DraftFabrikk']

    // keep !
    let passThroughFromBottom = {}
    passThroughFromBottom['@pencil/draft-knot-double-stacked-pointer'] = {}
    // keep

    passThrough['@pencil/draft-knot-double-stacked-pointer'] = function (spawnedPointerBelongings, passThroughKnot) {
...
passThroughFromBottom['@pencil/draft-knot-double-stacked-pointer']['FIELD_OF_VIEW'] = FIELD_OF_VIEW
passThroughFromBottom['@pencil/draft-knot-double-stacked-pointer']['PROJECTION_CENTER_Y'] = PROJECTION_CENTER_Y
passThroughFromBottom['@pencil/draft-knot-double-stacked-pointer']['PROJECTION_CENTER_X'] = PROJECTION_CENTER_X

passThroughFromBottom['@pencil/draft-knot-double-stacked-pointer']['canvas'] = ctx
...
// keep
window['@pencil/draft-knot-double-stacked-pointer'] = {
    passThrough: passThrough['@pencil/draft-knot-double-stacked-pointer'],
    passThroughFromBottom: passThroughFromBottom['@pencil/draft-knot-double-stacked-pointer']
}
// keep
