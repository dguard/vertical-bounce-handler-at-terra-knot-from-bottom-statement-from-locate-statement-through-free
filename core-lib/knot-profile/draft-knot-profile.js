...
(function() {
    ...
    const Pencil = window['@pencil/draft-compact-knot-profile']['Pencil']
    const DraftFabrikk = window['@pencil/draft-compact-knot-profile']['DraftFabrikk']

    // keep !
    let passThroughFromBottom = {}
    passThroughFromBottom['@pencil/draft-knot-profile'] = {}
    // keep

    passThrough['@pencil/draft-knot-profile'] = function (spawnedPointerBelongings, passThroughKnot) {
...
passThroughFromBottom['@pencil/draft-knot-profile']['FIELD_OF_VIEW'] = FIELD_OF_VIEW
passThroughFromBottom['@pencil/draft-knot-profile']['PROJECTION_CENTER_Y'] = PROJECTION_CENTER_Y
passThroughFromBottom['@pencil/draft-knot-profile']['PROJECTION_CENTER_X'] = PROJECTION_CENTER_X

passThroughFromBottom['@pencil/draft-knot-profile']['canvas'] = ctx
...
// keep
let knot1 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 * 4 /*  keep */, 1 /* keep */, 1 *  0.4)
...
// keep
window['@pencil/draft-knot-profile'] = {
    passThrough: passThrough['@pencil/draft-knot-profile'],
    passThroughFromBottom: passThroughFromBottom['@pencil/draft-knot-profile']
}
// keep
