...
(function() {
    ...
    const Pencil = window['@pencil/draft-compact-knot-front']['Pencil']
    const DraftFabrikk = window['@pencil/draft-compact-knot-front']['DraftFabrikk']

    // keep !
    let passThroughFromBottom = {}
    passThroughFromBottom['@pencil/draft-knot-front'] = {}
    // keep

    passThrough['@pencil/draft-knot-front'] = function (spawnedPointerBelongings, passThroughKnot) {
...
passThroughFromBottom['@pencil/draft-knot-front']['FIELD_OF_VIEW'] = FIELD_OF_VIEW
passThroughFromBottom['@pencil/draft-knot-front']['PROJECTION_CENTER_Y'] = PROJECTION_CENTER_Y
passThroughFromBottom['@pencil/draft-knot-front']['PROJECTION_CENTER_X'] = PROJECTION_CENTER_X

passThroughFromBottom['@pencil/draft-knot-front']['canvas'] = ctx
...
// keep
let knot1 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 * 0.7 /*  keep */, 1 /* keep */, 1 * /* keep */ 2 * constructedIncreaserPointer.increaser)
...
// keep
window['@pencil/draft-knot-front'] = {
    passThrough: passThrough['@pencil/draft-knot-front'],
    passThroughFromBottom: passThroughFromBottom['@pencil/draft-knot-front']
}
// keep
