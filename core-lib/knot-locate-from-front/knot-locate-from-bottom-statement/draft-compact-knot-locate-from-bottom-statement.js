...
function StickedAlbumReleasable() {
    let that = this
    ...
    that.addEventListener = function (event, cb) {
        ...
        // keep releasable
        dictKnot[chosenKnot].pictos[chosenPointer]['picto'].addEventListener = function () { /* keep */
        }
    }
    ...
    stickedAlbum.constructKnot('.pointer-into-bottom-statement')
...
function KnotFromBottomStatement(pencil) {
    ...
    that.throughStickedAlbum = function (stickedAlbum) {
        ...
        // keep
        return /* keep */ knotFromBottomStatement
        ...
        knotFromBottomStatement.stickedAlbum.ctx.addEventListener('click', function (event) {
            ...
            if([event.target].indexOf(knotFromBottomStatement.stickedAlbum.ctx.querySelector('.pointer-into-bottom-statement').querySelector(':nth-child(2)').querySelector('img')) !== -1) {
                if(knotFromBottomStatement.stickedAlbum.knotFrom('from-bottom-statement').at(2).getStatus() !== 'pressed') {
                    knotFromBottomStatement.stickedAlbum.knotFrom('from-bottom-statement').at(2).press()
    ...
    that.throughCtx = function (ctx) {
        ...
        // keep
        knotFromBottomStatement.stickedAlbum.knotFrom('pointer-into-bottom-statement').at(6).addEventListener('click', function () {

        })

        knotFromBottomStatement.stickedAlbum.knotFrom('pointer-into-bottom-statement').at(5).addEventListener('click', function () {
