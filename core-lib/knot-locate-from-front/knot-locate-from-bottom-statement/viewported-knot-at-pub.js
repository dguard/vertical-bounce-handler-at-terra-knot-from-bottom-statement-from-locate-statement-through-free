...
function KnotPointerBelongingsFromProfile() {
    // keep

    // pointerBelongingsFromProfileStatement
}

function KnotPointerBelongingsFromFront() {
    // keep

    // pointerBelongingsFromFrontStatement
}

function TerraKnotFromBottomStatement() {
    let that = this
    ...
    let passThrough = window['@pencil/draft-terra-knot-from-bottom-statement']['passThrough']
