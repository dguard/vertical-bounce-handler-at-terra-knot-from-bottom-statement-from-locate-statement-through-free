...
function RectangleOnPaper(radius, frontRatio, p, d, debthScaleRatio, profileScaleRatio, frontScaleRatio) {
    ...
    const FIELD_OF_VIEW = window['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing']['passThroughFromBottom']['FIELD_OF_VIEW']

    const PROJECTION_CENTER_Y = window['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing']['passThroughFromBottom']['PROJECTION_CENTER_Y']

    const PROJECTION_CENTER_X = window['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing']['passThroughFromBottom']['PROJECTION_CENTER_X']
    ...
    that.drawFromBottom = function () {
        ...
        const handleProjectAt1stIteration = window['@pencil/handle-knot-pointer-belongings-from-bottom-statement-from-closing']['handleProjectAt1stIteration']
        const handleProjectAt2ndIteration = window['@pencil/handle-knot-pointer-belongings-from-bottom-statement-from-closing']['handleProjectAt2ndIteration']
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            let ctx = window['@pencil/draft-knot-pointer-belongings-from-bottom-statement-from-closing']['passThroughFromBottom']['canvas']
...
window['@pencil/draft-compact-knot-pointer-belongings-from-bottom-statement-from-closing'] = {
    DraftFabrikk,
    Pencil
}
