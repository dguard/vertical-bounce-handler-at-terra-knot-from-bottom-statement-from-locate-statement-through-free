...
let constructIncreaserPointerFromPointerBelongingsFromProfile = function (knotWiFromBottomStatement, /* keep */ knotFromBottomStatement) {
    // keep knotWiFromKnotPointerBelongingsFromProfile
    // keep iterationCountFromKnotPointerBelongingsFromProfile
    ...
    // from original pointerBelongings
    // throughY, throughX
    // keep
    // knotAtDistanceX
    ...
    // alert(originalSpawnedPointerBelongings.knotAtDistanceX)
    ...
    for(fromTry = 1; fromTry < iterationCount; fromTry++) {
        // keep
        // use knotWiFromBottomStatement
        // use fromTry counter

        if((spawnedPointerBelongingsFromBottomStatement.x + fromTry * knotWiFromBottomStatement) < /* keep */ originalSpawnedPointerBelongings.throughX + knotWiFromBottomStatement - originalSpawnedPointerBelongings.throughKnotAtProfile.knotAtDistanceX && originalSpawnedPointerBelongings.throughX + knotWiFromBottomStatement /* keep */ - originalSpawnedPointerBelongings.throughKnotAtProfile.knotAtDistanceX < (spawnedPointerBelongingsFromBottomStatement.x + /* keep knotWi * fromTry */ + (knotWiFromBottomStatement * (fromTry + 1)))) {
            throughX = spawnedPointerBelongingsFromBottomStatement.x + fromTry * knotWiFromBottomStatement
            // keep
            fromTry++
            break
        }

        // if(spawnedPointerBelongingsFromBottomStatement.x + fromTry * knotWiFromBottomStatement /* keep + knotWi */ < (/* keep */ knotFromBottomStatement.throughX + knotWiFromBottomStatement /* keep */ /* keep */ /* + spawnedPointerBelongingsFromBottomStatement.x*/)
        //     /* keep */ /* keep // */ //&& (/* keep */ knotFromBottomStatement.throughX + knotWiFromBottomStatement /* keep */ + spawnedPointerBelongingsFromBottomStatement.x) < spawnedPointerBelongingsFromBottomStatement.x + knotWiFromBottomStatement * (fromTry + 1)
        // ) {
        //     fromTry++
        //     break
        // }
...
// keep !
    // keep increaserFromKnotPointerBelongingsFromProfile
    increaser = (knotWi / originalSpawnedPointerBelongings.knotRelativeSizeAtFront) * (fromTry + 1)
...
// }
    ...
    // keep throughYFromKnotPointerBelongingsFromProfile
    // fromDeTryFromKnotPointerBelongingsFromProfile
    // knotDeFromKnotPointerBelongingsFromProfile
    // iterationCountAtDeFromKnotPointerBelongingsFromProfile

    // keep
    let throughY
    let fromDeTry
    let knotDe = originalSpawnedPointerBelongings.knotRelativeSizeAtDebth / originalSpawnedPointerBelongings.throughKnotAtProfile.knotAtDistanceX
    ...
    // keep increaserDeFromKnotPointerBelongingsFromProfile
...
// keep spawnedPointerBelongingsFromBottomStatementFromKnotWi
let spawnedPointerBelongingsFromBottomStatement = {
    y: originalSpawnedPointerBelongings.y /*+ PROJECTION_CENTER_Y*/,
    x: originalSpawnedPointerBelongings.x + PROJECTION_CENTER_X
}
...
// keep knotPointerBelongingsFromProfileWi

// keep!

// keep
// knotWi
// knot.pointerBelongingsAtBottomLeft.x
let knotFromBottomStatement = {
    pointerBelongingsAtBottomLeft: {
        x: spawnedPointerBelongingsFromBottomStatement.x
    },
    throughY: throughY,
    // keep !
    // throughX: throughX,
    throughX: originalSpawnedPointerBelongings.throughX
}

let constructedIncreaserPointer = constructIncreaserPointerFromPointerBelongingsFromProfile(knotWi, knotFromBottomStatement)
// keep compact
spawnedPointerBelongings = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1 * 4 * 1.2 * increaserDe, 1 * 4 * 1.7 * 1.2/* is it gorgylya? */ /* throughX */ * increaser, 1 * 2 * 1.7)

// keep !
// keep !
spawnedPointerBelongings = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y - originalSpawnedPointerBelongings.knotAtProfile, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1 * 4 * 1.2 * increaserDe, 1 * 4 * 1.7 * 1.2/* is it gorgylya? */ /* throughX */ * (/* keep increaser - */  constructedIncreaserPointer.increaser), 1 * 2 * 1.7)
