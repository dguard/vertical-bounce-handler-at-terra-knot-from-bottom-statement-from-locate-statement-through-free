...
(function() {
    ...
    const Pencil = window['@pencil/draft-knot-locate-from-bottom-statement']['Pencil']
    const DraftFabrikk = window['@pencil/draft-knot-locate-from-bottom-statement']['DraftFabrikk']

    // keep !
    let passThroughFromBottom = {}
    passThroughFromBottom['@pencil/draft-knot-locate-from-front'] = {}
    // keep

    passThrough['@pencil/draft-knot-locate-from-front'] = function (spawnedPointerBelongings) {
        // keep
...
// keep original !
// keep
echoLocatorAtKnotLocate.useStickedAlbum(new StickedAlbumReleasable())
...
// keep
window['@pencil/draft-knot-locate-from-front'] = {
    passThrough: passThrough['@pencil/draft-knot-locate-from-front'],
    passThroughFromBottom: passThroughFromBottom['@pencil/draft-knot-locate-from-front']
}
// keep
})()