...
function RectangleOnPaper(radius, frontRatio, p, d, debthScaleRatio, profileScaleRatio, frontScaleRatio) {
    ...
    const FIELD_OF_VIEW = window['@pencil/draft-knot-double-stacked-pointer']['passThroughFromBottom']['FIELD_OF_VIEW']

    const PROJECTION_CENTER_Y = window['@pencil/draft-knot-double-stacked-pointer']['passThroughFromBottom']['PROJECTION_CENTER_Y']

    const PROJECTION_CENTER_X = window['@pencil/draft-knot-double-stacked-pointer']['passThroughFromBottom']['PROJECTION_CENTER_X']
    ...
    that.drawFromBottom = function () {
        ...
        const handleProjectAt1stIteration = window['@pencil/handle-knot-double-stacked-pointer']['handleProjectAt1stIteration']
        const handleProjectAt2ndIteration = window['@pencil/handle-knot-double-stacked-pointer']['handleProjectAt2ndIteration']
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            let ctx = window['@pencil/draft-knot-double-stacked-pointer']['passThroughFromBottom']['canvas']
...
window['@pencil/draft-compact-knot-double-stacked-pointer'] = {
    DraftFabrikk,
    Pencil
}
